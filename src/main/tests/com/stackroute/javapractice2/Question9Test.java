...
public class Question9Test {
    ...
    public void checkWordFrequency() throws IOException {
        File file = new File("/home/mritunjay/Documents/Java/Java_PROGRAM_PE_2/src/main/resources/text9.txt");
        assertEquals(21,(long)q9.checkWordFrequency(file.getAbsolutePath()));
